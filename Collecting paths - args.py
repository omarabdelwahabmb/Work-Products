...
run it using:
    python "Collecting paths - args.py" inputfilepath balcklistfilepath outputfilepath
    OR
    python "Collecting paths - args.py" inputfilepath outputfilepath
...
print ("filepath", filename) #For debugging
